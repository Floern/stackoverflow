...
function updateGlobalFlagStats() {
  let realTotal = flagGlobalSummaryStats.sumFlagsTotal - flagGlobalSummaryStats.sumFlagsPending - flagGlobalSummaryStats.sumFlagsRetracted;
...
function parseSiteFlagSummary(siteName, siteUserFlagSummaryUrl, html) {
  ...
  let realTotal = sumFlagsTotal - sumFlagsPending - sumFlagsRetracted;
